...
class  poetryGraph(object):
	...
	def __init__(self):
		...
		self.graph = Graph("http://localhost:7474", username="neo4j", password="shiyaohua2000")
	...
	def read_csv(self):
		...
		author_to_dynasty = []  #作者与朝代的关系--实体和时间

		author_to_title = []  #作者和题目的关系--实体和属性的关系
		poetry_to_tag = []  #诗和标签的关系--属性和标签的关系
		poetry_to_content = []
